        ...
        <section class="space-y-6">
            ...
            <div class="rounded-3xl border border-stone-200 bg-white p-6 shadow-sm">
                ...
                <div class="mt-4 grid gap-4 sm:grid-cols-3">
                    ...
                    <a href="/docs/class_diagram.pdf" target="_blank" rel="noreferrer" class="rounded-2xl border border-stone-200 bg-stone-50 px-4 py-4 text-sm font-semibold text-stone-900 hover:border-stone-300 hover:bg-stone-100">
